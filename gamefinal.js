game.things = (function(){
  var items = {
    bat: {
      name: 'bat',
      effects: {
        'player_inventory': { message: "<p>You picked up the Tim Cook!</p>",
                            object: "addItem",
                            subject: "deleteItem"
        },
        'dino': { message: "<p>You've given Steve Jobs a concussion.</p><p>Now he's dead</p>",
                  subject: 'deleteItem',
                  object: 'deleteItem',
    ...
    dino: {
      name: 'dino',
      effects: {
        'player_inventory': { message: "<p>You can't move Steve Jobs...</p>" } 
      }
    }
  };
